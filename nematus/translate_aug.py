...
try:
    from .beam_search_sampler import BiasedBeamSearchSampler
    from .biased_beam_search_sampler import BeamSearchSampler
    ...
    from . import translate_utils_aug
    from . import translate_utils
except (ModuleNotFoundError, ImportError) as e:
    from biased_beam_search_sampler import BiasedBeamSearchSampler
...
def main(settings):
    ...
    elif settings.translation_strategy == 'biased_beam_search':
        sampler = BiasedBeamSearchSampler(models, configs, settings.beam_size, settings.beta)
    else:
    ...
    translate_utils_aug.translate_file(
        ...
        mask=settings.mask,
        extended_translations=settings.extended_translations)
